...
shared_ptr<Texture> Resources::LoadPlayerIconTexture(int id)
{
	shared_ptr<Texture> texture = make_shared<Texture>();
	...
	{
	case 5:
		texture = GET_SINGLE(Resources)->Load<Texture>(L"Player_Icon_1", L"..\\Resources\\Texture\\PlayerIcon_Dealer.png");
		break;
	case 6:
		texture = GET_SINGLE(Resources)->Load<Texture>(L"Player_Icon_2", L"..\\Resources\\Texture\\PlayerIcon_Healer.png");
		break;
	case 7:
		texture = GET_SINGLE(Resources)->Load<Texture>(L"Player_Icon_3", L"..\\Resources\\Texture\\PlayerIcon_Launcher.png");
		break;
	case 8:
		texture = GET_SINGLE(Resources)->Load<Texture>(L"Player_Icon_4", L"..\\Resources\\Texture\\PlayerIcon_Tanker.png");
		break;
...
void Resources::LoadEnemyPrefab(int modelNum, Vec3 Location, Vec3 Scale, float hp, shared_ptr<Scene> scene, bool isLastWaveEnemy)
{
	int idx = 0;
	...
	//추가적인 컴포넌트 부착
	{
		...
		if (isLastWaveEnemy)
			scene->AddLastWaveEnemy(enemyScript);
...
void Resources::CreateDefaultMaterial()
{
	...
	// Particle
	{
		...
		shared_ptr<Material> material = make_shared<Material>();
		material->SetShader(shader);
		Add<Material>(L"Particle0", material);
	}
	...
	// ComputeParticle
	{
		...
		Add<Material>(L"ComputeParticle0", material);
	}
	...
	// Particle
	{
		...
		shared_ptr<Material> material = make_shared<Material>();
		material->SetShader(shader);
		Add<Material>(L"Particle1", material);
	}
	...
	// Particle
	{
		...
		shared_ptr<Material> material = make_shared<Material>();
		material->SetShader(shader);
		Add<Material>(L"Particle4", material);
	}
	...
	// ComputeParticle
	{
		...
		Add<Material>(L"ComputeParticle4", material);
	}
	...
	// Particle
	{
		...
		shared_ptr<Material> material = make_shared<Material>();
		material->SetShader(shader);
		Add<Material>(L"Particle5", material);
	}
	...
	// ComputeParticle
	{
		...
		Add<Material>(L"ComputeParticle5", material);
	}
	...
	// Particle
	{
		...
		shared_ptr<Material> material = make_shared<Material>();
		material->SetShader(shader);
		Add<Material>(L"Particle6", material);
	}
	...
	// ComputeParticle
	{
		...
		Add<Material>(L"ComputeParticle6", material);
	}
	...
	// Particle
	{
		...
		shared_ptr<Material> material = make_shared<Material>();
		material->SetShader(shader);
		Add<Material>(L"Particle7", material);
	}
	...
	// ComputeParticle
	{
		...
		Add<Material>(L"ComputeParticle7", material);
	}
