...
public:
	...
	shared_ptr<ComputeCommandQueue> GetComputeCmdQueue() { return m_computeCmdQueue; }
...
private:
	...
	shared_ptr<ComputeCommandQueue> m_computeCmdQueue = make_shared<ComputeCommandQueue>();
